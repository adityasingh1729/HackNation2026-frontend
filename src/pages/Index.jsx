...
import { ShoppingCart, Sparkles, Search, MessageCircle } from "lucide-react";
...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-24 pb-80 px-6">
            ...
            <h3 className="text-xl font-bold text-foreground mb-2">
              {totalItems > 0
                ...
                : hasResults
                  ...
                  : "Add items from search results to your cart"}
            </h3>
            <p className="text-muted-foreground text-sm mb-6 max-w-md mx-auto">
              {totalItems > 0
                ...
                : hasResults
                  ...
                  : "After you see results, add to cart and run checkout (simulated)"}
            </p>
            <button
